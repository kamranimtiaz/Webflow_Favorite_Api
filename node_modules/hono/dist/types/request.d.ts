import type { ParamIndexMap, ParamStash, Params } from 'hono/dist/types/router';
import type { Input, InputToDataByTarget, ParamKeys, ParamKeyToRecord, RemoveQuestion, UndefinedIfHavingQuestion, ValidationTargets } from 'hono/types';
